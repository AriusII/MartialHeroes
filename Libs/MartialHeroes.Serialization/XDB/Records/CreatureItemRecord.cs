...
/// <summary>
///     Creature/NPC spawn configuration from creature_item.xdb (48 bytes per record, 0x30).
///     Ghidra-confirmed: <c>XDB_LoadCreatureItem</c> @ 0x0053702D.
/// </summary>
/// <remarks>
///     <para>
///         Contains NPC/creature spawn configuration fields. Field semantics are partially known;
///         generic <c>Field1..Field11</c> naming is used to preserve round-trip fidelity.
///     </para>
///     <para>Field layout:</para>
///     <list type="bullet">
///         <item>
///             <description>+0x00 (4B): Id (uint32) — creature/item type ID (lookup key)</description>
///         </item>
///         <item>
///             <description>+0x04 (44B): 11 × int32 configuration fields at 4-byte intervals</description>
///         </item>
///     </list>
/// </remarks>
public readonly struct CreatureItemRecord
{
	/// <summary>Fixed size of one record in bytes (0x30).</summary>
	public const int Size = 48;

	/// <summary>Creature/item type ID — lookup key (u32 at +0x00).</summary>
	...
	/// <summary>Parses one <see cref="CreatureItemRecord" /> from 48 raw bytes.</summary>
	/// <param name="data">Source span containing at least <see cref="Size" /> bytes.</param>
	/// <returns>The parsed record.</returns>
	public static CreatureItemRecord Parse(ReadOnlySpan<byte> data)
	{
		return new CreatureItemRecord
		{
	...
	/// <param name="destination">Target span to write into (must be at least 48 bytes).</param>
